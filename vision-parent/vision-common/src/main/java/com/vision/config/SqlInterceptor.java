...
import com.vision.util.ConvertArrayUtil;
 ...
 * @Description mybatisplus拦截新增和修改动态添加创建时间和修改时间
 * @Author lihd
 * @Date 2019/8/9 19:37
 * @Version 3.1
 */
...
public class SqlInterceptor extends AbstractSqlParserHandler implements Interceptor {
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        if (parameter.getClass().getSuperclass() != null) {
            ...
            List list = new ArrayList(Arrays.asList(declaredFields));
            List list1 = new ArrayList(Arrays.asList(superField));
            list.addAll(list1);
            Object[] objects = list.toArray();
            declaredFields = ConvertArrayUtil.convertArray(Field.class, objects);
        }
        // mybatis plus判断
